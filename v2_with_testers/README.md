...
You have to erase the end "| pbcopy" OR you can change this last part for "| wl-copy" but you need to install it first (it is on Resources). This copies all the instructions generated. Otherwise, you will have to copy by yourself.git clone https://github.com/LeoFu9487/push_swap_tester.git && cd push_swap_tester
